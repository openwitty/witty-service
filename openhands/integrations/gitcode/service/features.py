...
class GitCodeFeaturesMixin(GitCodeMixinBase):
    """Microagent and feature helpers for GitCode."""
    ...
    async def get_microagent_content(
        ...
        try:
            ...
            return MicroagentContentResponse(
                ...
                path=file_path,
                triggers=[],
                git_provider=ProviderType.GITCODE.value,
            )
    ...
    def _log_microagent_warning(self, repository: str, message: str) -> None:
        logger.debug(f'GitCode microagent scan warning for {repository}: {message}')
